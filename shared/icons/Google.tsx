  ...
  return (
    ...
    >
      <g clipPath="url(#google_svg__a)">
        ...
        <path
          fill="#34A853"
          d="M12.24 24c3.236 0 5.965-1.062 7.954-2.896l-3.867-2.998c-1.076.731-2.465 1.146-4.084 1.146-3.13 0-5.785-2.112-6.737-4.952h-3.99v3.091a12 12 0 0 0 10.723 6.61"
        />
        <path
          fill="#FBBC04"
