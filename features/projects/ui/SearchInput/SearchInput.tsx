  ...
  return (
    <div className="relative">
      <input
        ...
        className="h-14 w-137.5 rounded-full bg-gray-800 px-4 py-2 pr-10 text-gray-400 placeholder:text-gray-400 focus:outline-none sm:max-w-[300px] md:max-w-[400px] lg:max-w-[550px]"
      />
