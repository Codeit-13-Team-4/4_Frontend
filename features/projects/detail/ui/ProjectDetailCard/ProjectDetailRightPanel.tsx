import type { ProjectDetail, CONTACT_METHOD } from "@/features/projects/model";
import { Progress, Separator } from "@/shared/ui";
import { PositionBadge, TechBadge } from "@/features/projects/ui";
import { CONTACT_METHOD as CONTACT_METHOD_MAP } from "@/features/projects/model";
      ...
      <div className="flex items-center gap-1.5 text-sm text-gray-500 lg:text-lg">
        ...
        {project.contactMethod === "email" ? (
          <span className="text-sm text-gray-400 lg:text-lg">
            {CONTACT_METHOD_MAP[project.contactMethod]} ({project.contactLink})
          </span>
        ) : (
          <a
