...
import { ChallengeApplication } from "@/features/challenges/model";

interface ChallengeRejectionReasonModalProps {
  application: ChallengeApplication;
  open: boolean;
  onOpenChange: (open: boolean) => void;
}

export default function ChallengeRejectionReasonModal({
  application,
  open,
  onOpenChange,
}: ChallengeRejectionReasonModalProps) {
  return (
